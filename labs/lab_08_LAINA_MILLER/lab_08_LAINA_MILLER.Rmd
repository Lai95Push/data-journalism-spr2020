...
```{r}
average_county_pills_per_year_url <- 'https://raw.githubusercontent.com/smussenden/spring20-data-journalism/master/labs/lab_05/data/county_pills_per_year.csv'

average_county_pills_per_year <- read.csv(average_county_pills_per_year_url)
...
This function pulls all the available variables for 2012 from the acs, with data from the previous 5 years averaged into a single estimate.  Here's a [good discussion of what that means](https://www.census.gov/data/developers/data-sets/acs-5year.html)
...
Let's examine this table together.  Be sure to watch the video where I'll review how to select variables using the data browser in R Studio. 
...
```{r}
state_white_ident_only <- get_acs(geography = "state", 
