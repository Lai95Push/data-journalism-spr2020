...
ggplot(mingo_county_pills_per_year) +
  geom_bar(stat="identity", aes(year, dosage_unit), fill = "royal blue") +
  labs(x = "Year", y = "Total Pills", title = "In Mingo County, opioids rise until 2008, then fall rapidly through 2014", subtitle = "Total pills shipped to Mingo County, WV, per year", caption = "Source: DEA ARCOS database, via Washington Post") +
  scale_x_continuous(breaks = c(2006, 2007, 2008, 2009, 2010, 2011, 2012, 2013, 2014)) +
  scale_y_continuous(labels = comma)
ggsave("mingo_county_pills.png", plot = last_plot())
```
...
```{r}
#making basic wv pills per county sheet
...
west_virginia_2012 <- west_virginia_pills_2012 %>%
  ...
  select(buyer_county, population, dosage_unit)
...
ggplot(west_virginia_2012) +
  ...
  scale_y_continuous(labels = comma) +
  scale_x_continuous(labels = comma, breaks = c(0, 25000, 50000, 75000, 100000, 125000, 150000, 175000, 200000)) + 
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  geom_smooth(aes(population, dosage_unit), method = "lm", se = FALSE) +
  geom_text_repel(aes(population, dosage_unit, label=buyer_county), 
                  subset(west_virginia_2012, dosage_unit > 3000000 & population > 35000)) 

#final form of scatterplot with line regression, adding title describing trends
ggplot(west_virginia_2012) +
  geom_point(aes(population, dosage_unit)) +
  labs(x="2012 Population", y="Total pills in 2012", title="Logan and Raleigh counties in West Virginia \nhad high number of opioids relative to population in 2012", subtitle="Monongalia and Berkeley counties had low number of opioids relative to population in 2012", caption = "Source: DEA ARCOS database, via Washington Post", fill="buyer_county") +
  scale_y_continuous(labels = comma) +
  scale_x_continuous(labels = comma, breaks = c(0, 25000, 50000, 75000, 100000, 125000, 150000, 175000, 200000)) + 
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  geom_smooth(aes(population, dosage_unit), method = "lm", se = FALSE) +
...
ggsave("west_virginia_counties_pills.png", plot = last_plot())
